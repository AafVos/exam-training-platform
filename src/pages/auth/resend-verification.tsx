...
export default function ResendVerificationPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (result.success) {
        setMessage(result.message || 'Nieuwe verificatie-e-mail verzonden!');
      } else {
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="text-center">
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Voer je e-mailadres in om een nieuwe verificatielink te ontvangen
          </p>
        </div>
      </div>
            ...
            {message && (
              <div className="bg-green-50 border border-green-200 rounded-md p-4">
                <div className="flex">
                  ...
                  <div className="ml-3">
                    <h3 className="text-sm font-medium text-green-800">Succes</h3>
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4">
          <div className="text-sm text-blue-800">
            ...
            <ul className="mt-2 list-disc list-inside space-y-1">
              ...
              <li>Je kunt alleen nieuwe e-mails aanvragen voor nog niet geverifieerde accounts</li>
            </ul>
          </div>
        </div>
      </div>
